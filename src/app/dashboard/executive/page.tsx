...
import { PortfolioTrend, HealthBreakdown } from "@/components/executive/ExecCharts";
import { SegmentBreakdown } from "@/components/profitability/Charts";
import TopAccounts from "@/components/executive/TopAccounts";
import ExecActivityFeed from "@/components/executive/ExecActivityFeed";
import { LayoutDashboard, Download, RefreshCw, Wifi } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-600 to-indigo-500 flex items-center justify-center shadow-sm ring-1 ring-white/40">
            <LayoutDashboard className="w-5 h-5 text-white" />
          </div>
          <div>
            <h1 className="text-xl font-bold text-surface-900 tracking-tight">Executive Overview</h1>
            <p className="text-xs text-surface-500 mt-0.5">
              Company-wide intelligence — unified across HubSpot, Stripe, Zendesk, Jira & Mixpanel
            </p>
          </div>
        </div>
